...
myPrayers is an app that users Firebase for authentication/storage/database
...
The opsions in the menu and profile settings should be intuitive.  The VOTD is set based on a User Default setting.
